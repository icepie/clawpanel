  ...
  page.innerHTML = `
    <div style="max-width:560px;margin:48px auto;text-align:center">
      <div style="margin-bottom:var(--space-lg)">
        <img src="/images/logo-brand.png" alt="NiceClaw" style="max-width:160px;width:100%;height:auto">
      </div>
      <h1 style="font-size:var(--font-size-xl);margin-bottom:var(--space-xs)">欢迎使用 NiceClaw</h1>
      ...
      ${nodeOk
        ...
        : `<p style="color:var(--text-secondary);font-size:var(--font-size-sm);margin-bottom:var(--space-sm)">
          ...
          <div style="margin-top:var(--space-sm);padding:8px 12px;background:var(--bg-tertiary);border-radius:var(--radius-sm);font-size:var(--font-size-xs);color:var(--text-secondary);line-height:1.6">
            ...
            ${isMacPlatform()
              ? `macOS 上从 Finder 启动可能找不到 Node.js。试试关掉 NiceClaw 后从终端启动：<br>
                 <code style="background:var(--bg-secondary);padding:2px 6px;border-radius:3px;user-select:all">open /Applications/NiceClaw.app</code>`
...
function renderInstallSection() {
  ...
  if (isDesktop) {
    envHint = `
      <div style="margin-top:var(--space-sm);padding:10px 12px;background:var(--bg-tertiary);border-radius:var(--radius-sm);border-left:3px solid var(--warning);font-size:var(--font-size-xs);color:var(--text-secondary);line-height:1.7">
        ...
        <p style="margin:6px 0 2px">NiceClaw 桌面版只能管理<strong>本机</strong>安装的 OpenClaw。以下环境中的安装无法被检测到：</p>
          ...
          <div style="margin-top:8px">
            ${isWin ? `
              <div style="margin-bottom:10px">
                ...
                <div style="margin-bottom:2px;opacity:0.8">打开 WSL 终端，一键部署 NiceClaw Web 版：</div>
            ...
            <div style="margin-bottom:10px">
              ...
              <div style="margin-bottom:2px;opacity:0.8">在容器内安装 OpenClaw + NiceClaw Web 版：</div>
  ...
  return `
    <p style="color:var(--text-secondary);font-size:var(--font-size-sm);margin-bottom:var(--space-sm)">
      点击安装后，将默认安装当前 NiceClaw 版本绑定的推荐稳定版；如需升降级，可稍后到「关于」页面切换版本。
    </p>
